...
public class Rat1 extends Robot {
  ...
  public void run() {
    ...
    while (step(timeStep) != -1) {
      ...
      if (distance[3]+distance[2] <550 ||distance[3]+distance[4] > 700 ){//1800
         if (!turn) {
          turn = true;
          
          
          if(distance[3]+distance[2]<550){//450
            System.out.println("Moving Right");   
            right = true;
         }//MUST CHANGE IN ORDER TO FOLLOW LEFT
          if (distance[3]+distance[4] > 800) {
            System.out.println("WALL, turn right"); 
            right = false;
          }
