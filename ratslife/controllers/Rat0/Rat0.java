...
public class Rat0 extends Robot {
  ...
  protected final double[] collisionAvoidanceWeights = {0.0,0.0,0.015,0.045,-0.045,-0.015,0.0,0.0};//0.5
  protected final double[]         slowMotionWeights = {0.0,0.0,0.0,0.009,0.009,0.0,0.0,0.0};//1042
  ...
  public void run() {
    ...
    while (step(timeStep) != -1) {
      ...
      if (distance[5]+distance[4] <550 ||distance[3]+distance[4] > 700 ){//1800
         if (!turn) {
          turn = true;
          
          
          if(distance[5]+distance[4]<550){//450
            //System.out.println("Moving Left");   
            right = false;}//MUST CHANGE IN ORDER TO FOLLOW LEFT
          else {
           // System.out.println("WALL, turn left"); 
            right = true;}
